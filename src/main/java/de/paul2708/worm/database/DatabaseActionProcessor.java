        ...
        if (action instanceof SaveAction) {
            ...
            for (ColumnAttribute column : resolver.getColumns()) {
                if (column.isReference()) {
                    CrudRepository referenceRepository = Repository.create(CrudRepository.class, column.getProperty(ReferenceProperty.class).getReference(),
                            database);
                    Object referenceEntity = referenceRepository.save(column.getValue(targetEntity));

                    column.setValue(targetEntity, referenceEntity);
                }
            }
